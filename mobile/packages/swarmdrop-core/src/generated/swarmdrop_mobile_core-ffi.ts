...
interface NativeModuleInterface {
    ...
    ubrn_uniffi_swarmdrop_mobile_core_fn_method_mobilecore_consume_pair_invite(ptr: bigint, invite: Uint8Array): bigint;
    ubrn_uniffi_swarmdrop_mobile_core_fn_method_mobilecore_decode_pair_invite(ptr: bigint, invite: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_swarmdrop_mobile_core_fn_method_mobilecore_generate_pair_invite(ptr: bigint, localOnly: number): bigint;
    ubrn_uniffi_swarmdrop_mobile_core_fn_method_mobilecore_invite_qr_matrix(ptr: bigint, invite: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_swarmdrop_mobile_core_fn_method_mobilecore_pair_direct(ptr: bigint, peerId: Uint8Array): bigint;
    ubrn_uniffi_swarmdrop_mobile_core_fn_method_mobilecore_respond_pairing_request(ptr: bigint, pendingId: bigint, accept: number): bigint;
